//Кастомный процесс освящения, моления    -обертка
...
DelayCommand(0.8, PlayAnimation(ANIMATION_LOOPING_MEDITATE, 1.0, fTime));


//Функция для просчетов
//Запустим скрипт неймлеса поверх анимации моления
