...
string pGetSpellLeveledLessThen(int iLevel = 0, int iLessThan = 0,
		int iTrustPercent = 20);
...
//                то необходимо задать "доверие" функции, ибо ресурсоемкая, это насколько ее результаты анализа будут исчерпывающими,
//                т.е. грубо говоря скоко процентов от 800+ заклинаний она проанализирует.
string pGetSpellLeveledMoreThen(int iLevel = 0, int iMoreThan = 0,
		int iTrustPercent = 20);
...
struct stSpellData pGetSpellInfo(int iSpell = -1) {
	...
	switch (iSpell) {
	case 0: {
		stRet.sName = "Acid_Fog";
		stRet.iSchool = 2;
		stRet.sTargetType = "0x3E";
		stRet.iCategory = 11;
		stRet.iLevel = 6;
	}
		;
	...
	case 2: {
		stRet.sName = "Animate_Dead";
		stRet.iSchool = 7;
		stRet.sTargetType = "0x2C";
		stRet.iCategory = 15;
		stRet.iLevel = 3;
	}
		;
	...
	case 4: {
		stRet.sName = "Bestow_Curse";
		stRet.iSchool = 8;
		stRet.sTargetType = "0x2A";
		stRet.iCategory = 3;
		stRet.iLevel = 3;
	}
		;
	...
	case 5: {
		stRet.sName = "Blade_Barrier";
		stRet.iSchool = 5;
		stRet.sTargetType = "0x2E";
		stRet.iCategory = 11;
		stRet.iLevel = 6;
	}
		;
	...
	case 7: {
		stRet.sName = "Bless_Weapon";
		stRet.iSchool = 8;
		stRet.sTargetType = "0x28";
		stRet.iCategory = 9;
		stRet.iLevel = 1;
	}
		;
	...
	case 8: {
		stRet.sName = "Blindness_and_Deafness";
		stRet.iSchool = 4;
		stRet.sTargetType = "0x2A";
		stRet.iCategory = 2;
		stRet.iLevel = 2;
	...
	case 14: {
		stRet.sName = "Chain_Lightning";
		stRet.iSchool = 5;
		stRet.sTargetType = "0x3A";
		stRet.iCategory = 1;
		stRet.iLevel = 6;
	}
		;
	...
	case 17: {
		stRet.sName = "Charm_Person_or_Animal";
		stRet.iSchool = 4;
		stRet.sTargetType = "0x2A";
		stRet.iCategory = 2;
		stRet.iLevel = 2;
	...
	case 20: {
		stRet.sName = "Clairaudience_and_Clairvoyance";
		stRet.iSchool = 3;
		stRet.sTargetType = "0x2B";
		stRet.iCategory = -1;
		stRet.iLevel = 3;
	...
	case 22: {
		stRet.sName = "Cloak_of_Chaos";
		stRet.iSchool = 1;
		stRet.sTargetType = "0x09";
		stRet.iCategory = 10;
		stRet.iLevel = 8;
	}
		;
	...
	case 29: {
		stRet.sName = "Create_Greater_Undead";
		stRet.iSchool = 7;
		stRet.sTargetType = "0x2C";
		stRet.iCategory = 15;
		stRet.iLevel = 8;
	...
	case 31: {
		stRet.sName = "Cure_Critical_Wounds";
		stRet.iSchool = 2;
		stRet.sTargetType = "0x2B";
		stRet.iCategory = 5;
		stRet.iLevel = 4;
	...
	case 34: {
		stRet.sName = "Cure_Moderate_Wounds";
		stRet.iSchool = 2;
		stRet.sTargetType = "0x2B";
		stRet.iCategory = 5;
		stRet.iLevel = 2;
	...
	case 35: {
		stRet.sName = "Cure_Serious_Wounds";
		stRet.iSchool = 2;
		stRet.sTargetType = "0x2B";
		stRet.iCategory = 5;
		stRet.iLevel = 3;
	...
	case 39: {
		stRet.sName = "Delayed_Blast_Fireball";
		stRet.iSchool = 5;
		stRet.sTargetType = "0x3E";
		stRet.iCategory = 11;
		stRet.iLevel = 7;
	...
	case 56: {
		stRet.sName = "Finger_of_Death";
		stRet.iSchool = 7;
		stRet.sTargetType = "0x0A";
		stRet.iCategory = 2;
		stRet.iLevel = 7;
	}
		;
	...
	case 57: {
		stRet.sName = "Fire_Storm";
		stRet.iSchool = 5;
		stRet.sTargetType = "0x05";
		stRet.iCategory = 1;
		stRet.iLevel = 7;
	}
		;
	...
	case 62: {
		stRet.sName = "Freedom_of_Movement";
		stRet.iSchool = 1;
		stRet.sTargetType = "0x3B";
		stRet.iCategory = 9;
		stRet.iLevel = 4;
	}
		;
	...
	case 65: {
		stRet.sName = "Globe_of_Invulnerability";
		stRet.iSchool = 1;
		stRet.sTargetType = "0x09";
		stRet.iCategory = 12;
		stRet.iLevel = 6;
	...
	case 67: {
		stRet.sName = "Greater_Dispelling";
		stRet.iSchool = 1;
		stRet.sTargetType = "0x2F";
		stRet.iCategory = 2;
		stRet.iLevel = 5;
	...
	case 68: {
		stRet.sName = "Greater_Magic_Weapon";
		stRet.iSchool = 8;
		stRet.sTargetType = "0x28";
		stRet.iCategory = 9;
		stRet.iLevel = 3;
	...
	case 69: {
		stRet.sName = "Greater_Planar_Binding";
		stRet.iSchool = 2;
		stRet.sTargetType = "0x2E";
		stRet.iCategory = 15;
		stRet.iLevel = 8;
	...
	case 70: {
		stRet.sName = "Greater_Restoration";
		stRet.iSchool = 7;
		stRet.sTargetType = "0x2B";
		stRet.iCategory = 7;
		stRet.iLevel = 7;
	...
	case 71: {
		stRet.sName = "Greater_Shadow_Conjuration";
		stRet.iSchool = 6;
		stRet.sTargetType = "0x2F";
		stRet.iCategory = -1;
		stRet.iLevel = 5;
	...
	case 72: {
		stRet.sName = "Greater_Spell_Breach";
		stRet.iSchool = 1;
		stRet.sTargetType = "0x2A";
		stRet.iCategory = 2;
		stRet.iLevel = 6;
	...
	case 73: {
		stRet.sName = "Greater_Spell_Mantle";
		stRet.iSchool = 1;
		stRet.sTargetType = "0x09";
		stRet.iCategory = 12;
		stRet.iLevel = 9;
	...
	case 76: {
		stRet.sName = "Hammer_of_the_Gods";
		stRet.iSchool = 5;
		stRet.sTargetType = "0x3E";
		stRet.iCategory = 1;
		stRet.iLevel = 4;
	...
	case 88: {
		stRet.sName = "Improved_Invisibility";
		stRet.iSchool = 6;
		stRet.sTargetType = "0x2B";
		stRet.iCategory = 9;
		stRet.iLevel = 4;
	...
	case 91: {
		stRet.sName = "Invisibility_Purge";
		stRet.iSchool = 5;
		stRet.sTargetType = "0x05";
		stRet.iCategory = 6;
		stRet.iLevel = 3;
	...
	case 92: {
		stRet.sName = "Invisibility_Sphere";
		stRet.iSchool = 6;
		stRet.sTargetType = "0x09";
		stRet.iCategory = 8;
		stRet.iLevel = 3;
	...
	case 96: {
		stRet.sName = "Lesser_Planar_Binding";
		stRet.iSchool = 2;
		stRet.sTargetType = "0x2E";
		stRet.iCategory = 15;
		stRet.iLevel = 5;
	...
	case 97: {
		stRet.sName = "Lesser_Restoration";
		stRet.iSchool = 2;
		stRet.sTargetType = "0x2B";
		stRet.iCategory = 7;
		stRet.iLevel = 2;
	...
	case 98: {
		stRet.sName = "Lesser_Spell_Breach";
		stRet.iSchool = 1;
		stRet.sTargetType = "0x2A";
		stRet.iCategory = 2;
		stRet.iLevel = 4;
	...
	case 99: {
		stRet.sName = "Lesser_Spell_Mantle";
		stRet.iSchool = 1;
		stRet.sTargetType = "0x09";
		stRet.iCategory = 12;
		stRet.iLevel = 5;
	...
	case 103: {
		stRet.sName = "Magic_Circle_against_Chaos";
		stRet.iSchool = 1;
		stRet.sTargetType = "0x2B";
		stRet.iCategory = 8;
		stRet.iLevel = 3;
	...
	case 104: {
		stRet.sName = "Magic_Circle_against_Evil";
		stRet.iSchool = 1;
		stRet.sTargetType = "0x2B";
		stRet.iCategory = 8;
		stRet.iLevel = 3;
	...
	case 105: {
		stRet.sName = "Magic_Circle_against_Good";
		stRet.iSchool = 1;
		stRet.sTargetType = "0x2B";
		stRet.iCategory = 8;
		stRet.iLevel = 3;
	...
	case 106: {
		stRet.sName = "Magic_Circle_against_Law";
		stRet.iSchool = 1;
		stRet.sTargetType = "0x2B";
		stRet.iCategory = 8;
		stRet.iLevel = 3;
	...
	case 110: {
		stRet.sName = "Mass_Blindness_and_Deafness";
		stRet.iSchool = 6;
		stRet.sTargetType = "0x2E";
		stRet.iCategory = 1;
		stRet.iLevel = 8;
	...
	case 116: {
		stRet.sName = "Meteor_Swarm";
		stRet.iSchool = 5;
		stRet.sTargetType = "0x0D";
		stRet.iCategory = 1;
		stRet.iLevel = 9;
	}
		;
	...
	case 119: {
		stRet.sName = "Minor_Globe_of_Invulnerability";
		stRet.iSchool = 1;
		stRet.sTargetType = "0x09";
		stRet.iCategory = 12;
		stRet.iLevel = 4;
	...
	case 122: {
		stRet.sName = "Mordenkainens_Disjunction";
		stRet.iSchool = 1;
		stRet.sTargetType = "0x2F";
		stRet.iCategory = 11;
		stRet.iLevel = 9;
	...
	case 123: {
		stRet.sName = "Mordenkainens_Sword";
		stRet.iSchool = 8;
		stRet.sTargetType = "0x2C";
		stRet.iCategory = 15;
		stRet.iLevel = 7;
	...
	case 125: {
		stRet.sName = "Negative_Energy_Protection";
		stRet.iSchool = 1;
		stRet.sTargetType = "0x2B";
		stRet.iCategory = 12;
		stRet.iLevel = 3;
	...
	case 136: {
		stRet.sName = "Protection__from_Chaos";
		stRet.iSchool = 1;
		stRet.sTargetType = "0x2B";
		stRet.iCategory = -1;
		stRet.iLevel = 1;
	...
	case 137: {
		stRet.sName = "Protection_from_Elements";
		stRet.iSchool = 1;
		stRet.sTargetType = "0x2B";
		stRet.iCategory = 13;
		stRet.iLevel = 3;
	...
	case 138: {
		stRet.sName = "Protection_from_Evil";
		stRet.iSchool = 1;
		stRet.sTargetType = "0x2B";
		stRet.iCategory = 13;
		stRet.iLevel = 1;
	...
	case 139: {
		stRet.sName = "Protection_from_Good";
		stRet.iSchool = 1;
		stRet.sTargetType = "0x2B";
		stRet.iCategory = 13;
		stRet.iLevel = 1;
	...
	case 140: {
		stRet.sName = "Protection_from_Law";
		stRet.iSchool = 1;
		stRet.sTargetType = "0x2B";
		stRet.iCategory = -1;
		stRet.iLevel = 1;
	...
	case 141: {
		stRet.sName = "Protection_from_Spells";
		stRet.iSchool = 4;
		stRet.sTargetType = "0x2F";
		stRet.iCategory = 14;
		stRet.iLevel = 7;
	...
	case 143: {
		stRet.sName = "Ray_of_Enfeeblement";
		stRet.iSchool = 7;
		stRet.sTargetType = "0x2A";
		stRet.iCategory = 2;
		stRet.iLevel = 1;
	...
	case 145: {
		stRet.sName = "Remove_Blindness_and_Deafness";
		stRet.iSchool = 3;
		stRet.sTargetType = "0x2F";
		stRet.iCategory = 6;
		stRet.iLevel = 3;
	...
	case 159: {
		stRet.sName = "Shadow_Conjuration";
		stRet.iSchool = 6;
		stRet.sTargetType = "0x2F";
		stRet.iCategory = -1;
		stRet.iLevel = 4;
	...
	case 173: {
		stRet.sName = "Storm_of_Vengeance";
		stRet.iSchool = 2;
		stRet.sTargetType = "0x05";
		stRet.iCategory = 1;
		stRet.iLevel = 9;
	...
	case 175: {
		stRet.sName = "Summon_Creature_II";
		stRet.iSchool = 2;
		stRet.sTargetType = "0x2C";
		stRet.iCategory = 15;
		stRet.iLevel = 2;
	...
	case 176: {
		stRet.sName = "Summon_Creature_III";
		stRet.iSchool = 2;
		stRet.sTargetType = "0x2C";
		stRet.iCategory = 15;
		stRet.iLevel = 3;
	...
	case 177: {
		stRet.sName = "Summon_Creature_IV";
		stRet.iSchool = 2;
		stRet.sTargetType = "0x2C";
		stRet.iCategory = 15;
		stRet.iLevel = 4;
	...
	case 178: {
		stRet.sName = "Summon_Creature_IX";
		stRet.iSchool = 2;
		stRet.sTargetType = "0x2C";
		stRet.iCategory = 15;
		stRet.iLevel = 9;
	...
	case 180: {
		stRet.sName = "Summon_Creature_VI";
		stRet.iSchool = 2;
		stRet.sTargetType = "0x2C";
		stRet.iCategory = 15;
		stRet.iLevel = 6;
	...
	case 181: {
		stRet.sName = "Summon_Creature_VII";
		stRet.iSchool = 2;
		stRet.sTargetType = "0x2C";
		stRet.iCategory = 15;
		stRet.iLevel = 7;
	...
	case 182: {
		stRet.sName = "Summon_Creature_VIII";
		stRet.iSchool = 2;
		stRet.sTargetType = "0x2C";
		stRet.iCategory = 15;
		stRet.iLevel = 8;
	...
	case 184: {
		stRet.sName = "Tensers_Transformation";
		stRet.iSchool = 8;
		stRet.sTargetType = "0x09";
		stRet.iCategory = 10;
		stRet.iLevel = 6;
	...
	case 190: {
		stRet.sName = "Wail_of_the_Banshee";
		stRet.iSchool = 7;
		stRet.sTargetType = "0x2E";
		stRet.iCategory = 1;
		stRet.iLevel = 9;
	...
	case 321: {
		stRet.sName = "PROTECTION_FROM_ALIGNMENT";
		stRet.iSchool = 1;
		stRet.sTargetType = "0x2B";
		stRet.iCategory = -1;
		stRet.iLevel = 1;
	...
	case 322: {
		stRet.sName = "Magic_Circle_against_Alignment";
		stRet.iSchool = 1;
		stRet.sTargetType = "0x2B";
		stRet.iCategory = -1;
		stRet.iLevel = 3;
	...
	case 323: {
		stRet.sName = "Aura_versus_Alignment";
		stRet.iSchool = 1;
		stRet.sTargetType = "0x29";
		stRet.iCategory = -1;
		stRet.iLevel = 8;
	}
		;
	...
	case 324: {
		stRet.sName = "SHADES_Summon_Shadow";
		stRet.iSchool = 2;
		stRet.sTargetType = "0x2C";
		stRet.iCategory = 1;
		stRet.iLevel = 4;
	...
	case 340: {
		stRet.sName = "SHADES_Cone_of_Cold";
		stRet.iSchool = 5;
		stRet.sTargetType = "0x3E";
		stRet.iCategory = 11;
		stRet.iLevel = 5;
	...
	case 343: {
		stRet.sName = "SHADES_Wall_of_Fire";
		stRet.iSchool = 5;
		stRet.sTargetType = "0x2E";
		stRet.iCategory = 11;
		stRet.iLevel = 4;
	...
	case 344: {
		stRet.sName = "SHADOW_CON_Summon_Shadow";
		stRet.iSchool = 2;
		stRet.sTargetType = "0x2C";
		stRet.iCategory = 1;
		stRet.iLevel = 4;
	...
	case 345: {
		stRet.sName = "SHADOW_CON_Darkness";
		stRet.iSchool = 5;
		stRet.sTargetType = "0x2F";
		stRet.iCategory = 11;
		stRet.iLevel = 2;
	...
	case 346: {
		stRet.sName = "SHADOW_CON_Inivsibility";
		stRet.iSchool = 6;
		stRet.sTargetType = "0x2B";
		stRet.iCategory = 9;
		stRet.iLevel = 2;
	...
	case 347: {
		stRet.sName = "SHADOW_CON_Mage_Armor";
		stRet.iSchool = 2;
		stRet.sTargetType = "0x2B";
		stRet.iCategory = 13;
		stRet.iLevel = 1;
	...
	case 348: {
		stRet.sName = "SHADOW_CON_Magic_Missile";
		stRet.iSchool = 5;
		stRet.sTargetType = "0x3A";
		stRet.iCategory = 2;
		stRet.iLevel = 1;
	...
	case 349: {
		stRet.sName = "GR_SHADOW_CON_Summon_Shadow";
		stRet.iSchool = 2;
		stRet.sTargetType = "0x2C";
		stRet.iCategory = 1;
		stRet.iLevel = 4;
	...
	case 350: {
		stRet.sName = "GR_SHADOW_CON_Acid_Arrow";
		stRet.iSchool = 2;
		stRet.sTargetType = "0x2A";
		stRet.iCategory = 2;
		stRet.iLevel = 2;
	...
	case 351: {
		stRet.sName = "GR_SHADOW_CON_Ghostly_Visage";
		stRet.iSchool = 6;
		stRet.sTargetType = "0x29";
		stRet.iCategory = 13;
		stRet.iLevel = 2;
	...
	case 353: {
		stRet.sName = "GR_SHADOW_CON_Minor_Globe";
		stRet.iSchool = 1;
		stRet.sTargetType = "0x29";
		stRet.iCategory = 12;
		stRet.iLevel = 4;
	...
	case 357: {
		stRet.sName = "Greater_Eagle_Splendor";
		stRet.iSchool = 8;
		stRet.sTargetType = "0x2B";
		stRet.iCategory = 9;
		stRet.iLevel = 6;
	...
	case 358: {
		stRet.sName = "Greater_Owls_Wisdom";
		stRet.iSchool = 8;
		stRet.sTargetType = "0x2B";
		stRet.iCategory = 9;
		stRet.iLevel = 6;
	...
	case 359: {
		stRet.sName = "Greater_Foxs_Cunning";
		stRet.iSchool = 8;
		stRet.sTargetType = "0x2B";
		stRet.iCategory = 9;
		stRet.iLevel = 6;
	...
	case 360: {
		stRet.sName = "Greater_Bulls_Strength";
		stRet.iSchool = 8;
		stRet.sTargetType = "0x2B";
		stRet.iCategory = 9;
		stRet.iLevel = 6;
	...
	case 361: {
		stRet.sName = "Greater_Cats_Grace";
		stRet.iSchool = 8;
		stRet.sTargetType = "0x2B";
		stRet.iCategory = 9;
		stRet.iLevel = 6;
	...
	case 364: {
		stRet.sName = "Creeping_Doom";
		stRet.iSchool = 2;
		stRet.sTargetType = "0x3f";
		stRet.iCategory = 1;
		stRet.iLevel = 7;
	}
		;
	...
	case 365: {
		stRet.sName = "Ultravision";
		stRet.iSchool = 8;
		stRet.sTargetType = "0x0b";
		stRet.iCategory = 10;
		stRet.iLevel = 2;
	}
		;
	...
	case 370: {
		stRet.sName = "Negative_Energy_Burst";
		stRet.iSchool = 7;
		stRet.sTargetType = "0x2E";
		stRet.iCategory = 1;
		stRet.iLevel = 3;
	...
	case 371: {
		stRet.sName = "Negative_Energy_Ray";
		stRet.iSchool = 7;
		stRet.sTargetType = "0x2A";
		stRet.iCategory = 2;
		stRet.iLevel = 1;
	...
	case 375: {
		stRet.sName = "Evards_Black_Tentacles";
		stRet.iSchool = 2;
		stRet.sTargetType = "0x3E";
		stRet.iCategory = 1;
		stRet.iLevel = 4;
	...
	case 380: {
		stRet.sName = "Battle_Mastery_Spell";
		stRet.iSchool = 2;
		stRet.sTargetType = "0x01";
		stRet.iCategory = 10;
		stRet.iLevel = 1;
	}
		;
	...
	case 383: {
		stRet.sName = "Negative_Plane_Avatar";
		stRet.iSchool = 2;
		stRet.sTargetType = "0x01";
		stRet.iCategory = 10;
		stRet.iLevel = 1;
	...
	case 387: {
		stRet.sName = "Polymorph_GIANT_SPIDER";
		stRet.iSchool = 8;
		stRet.sTargetType = "0x09";
		stRet.iCategory = -1;
		stRet.iLevel = 3;
	...
	case 389: {
		stRet.sName = "Polymorph_UMBER_HULK";
		stRet.iSchool = 8;
		stRet.sTargetType = "0x09";
		stRet.iCategory = -1;
		stRet.iLevel = 3;
	...
	case 392: {
		stRet.sName = "Shapechange_RED_DRAGON";
		stRet.iSchool = 8;
		stRet.sTargetType = "0x09";
		stRet.iCategory = -1;
		stRet.iLevel = 9;
	...
	case 393: {
		stRet.sName = "Shapechange_FIRE_GIANT";
		stRet.iSchool = 8;
		stRet.sTargetType = "0x09";
		stRet.iCategory = -1;
		stRet.iLevel = 9;
	...
	case 395: {
		stRet.sName = "Shapechange_DEATH_SLAAD";
		stRet.iSchool = 8;
		stRet.sTargetType = "0x09";
		stRet.iCategory = -1;
		stRet.iLevel = 9;
	...
	case 396: {
		stRet.sName = "Shapechange_IRON_GOLEM";
		stRet.iSchool = 8;
		stRet.sTargetType = "0x09";
		stRet.iCategory = -1;
		stRet.iLevel = 9;
	...
	case 431: {
		stRet.sName = "Inflict_Minor_Wounds";
		stRet.iSchool = 7;
		stRet.sTargetType = "0x3A";
		stRet.iCategory = -1;
		stRet.iLevel = 0;
	...
	case 432: {
		stRet.sName = "Inflict_Light_Wounds";
		stRet.iSchool = 7;
		stRet.sTargetType = "0x3A";
		stRet.iCategory = -1;
		stRet.iLevel = 1;
	...
	case 433: {
		stRet.sName = "Inflict_Moderate_Wounds";
		stRet.iSchool = 7;
		stRet.sTargetType = "0x3A";
		stRet.iCategory = -1;
		stRet.iLevel = 2;
	...
	case 434: {
		stRet.sName = "Inflict_Serious_Wounds";
		stRet.iSchool = 7;
		stRet.sTargetType = "0x3A";
		stRet.iCategory = -1;
		stRet.iLevel = 3;
	...
	case 435: {
		stRet.sName = "Inflict_Critical_Wounds";
		stRet.iSchool = 7;
		stRet.sTargetType = "0x3A";
		stRet.iCategory = 3;
		stRet.iLevel = 4;
	...
	case 444: {
		stRet.sName = "Undeaths_Eternal_Foe";
		stRet.iSchool = 1;
		stRet.sTargetType = "0x2F";
		stRet.iCategory = 9;
		stRet.iLevel = 9;
	...
	case 447: {
		stRet.sName = "Isaacs_Lesser_Missile_Storm";
		stRet.iSchool = 5;
		stRet.sTargetType = "0x1E";
		stRet.iCategory = 2;
		stRet.iLevel = 4;
	}
		;
	...
	case 448: {
		stRet.sName = "Isaacs_Greater_Missile_Storm";
		stRet.iSchool = 5;
		stRet.sTargetType = "0x1E";
		stRet.iCategory = 2;
		stRet.iLevel = 6;
	...
	case 453: {
		stRet.sName = "Greater_Magic_Fang";
		stRet.iSchool = 2;
		stRet.sTargetType = "0x09";
		stRet.iCategory = 13;
		stRet.iLevel = 3;
	...
	case 456: {
		stRet.sName = "Expeditious_Retreat";
		stRet.iSchool = 8;
		stRet.sTargetType = "0x09";
		stRet.iCategory = 10;
		stRet.iLevel = 1;
	...
	case 457: {
		stRet.sName = "Tashas_Hideous_Laughter";
		stRet.iSchool = 4;
		stRet.sTargetType = "0x3A";
		stRet.iCategory = 2;
		stRet.iLevel = 2;
	...
	case 459: {
		stRet.sName = "Bigbys_Interposing_Hand";
		stRet.iSchool = 5;
		stRet.sTargetType = "0x3A";
		stRet.iCategory = 2;
		stRet.iLevel = 5;
	...
	case 460: {
		stRet.sName = "Bigbys_Forceful_Hand";
		stRet.iSchool = 5;
		stRet.sTargetType = "0x3A";
		stRet.iCategory = 2;
		stRet.iLevel = 6;
	...
	case 461: {
		stRet.sName = "Bigbys_Grasping_Hand";
		stRet.iSchool = 5;
		stRet.sTargetType = "0x3A";
		stRet.iCategory = 2;
		stRet.iLevel = 7;
	...
	case 462: {
		stRet.sName = "Bigbys_Clenched_Fist";
		stRet.iSchool = 5;
		stRet.sTargetType = "0x3A";
		stRet.iCategory = 2;
		stRet.iLevel = 8;
	...
	case 463: {
		stRet.sName = "Bigbys_Crushing_Hand";
		stRet.iSchool = 5;
		stRet.sTargetType = "0x3A";
		stRet.iCategory = 2;
		stRet.iLevel = 9;
	...
	case 513: {
		stRet.sName = "Infestation_of_Maggots";
		stRet.iSchool = 7;
		stRet.sTargetType = "0x0A";
		stRet.iCategory = 3;
		stRet.iLevel = 3;
	...
	case 520: {
		stRet.sName = "Gedlees_Electric_Loop";
		stRet.iSchool = 5;
		stRet.sTargetType = "0x0E";
		stRet.iCategory = 1;
		stRet.iLevel = 2;
	}
		;
	...
	case 523: {
		stRet.sName = "Mestils_Acid_Breath";
		stRet.iSchool = 2;
		stRet.sTargetType = "0x3E";
		stRet.iCategory = 11;
		stRet.iLevel = 3;
	...
	case 524: {
		stRet.sName = "Mestils_Acid_Sheath";
		stRet.iSchool = 2;
		stRet.sTargetType = "0x09";
		stRet.iCategory = 12;
		stRet.iLevel = 5;
	...
	case 525: {
		stRet.sName = "Monstrous_Regeneration";
		stRet.iSchool = 2;
		stRet.sTargetType = "0x0B";
		stRet.iCategory = 10;
		stRet.iLevel = 5;
	...
	case 526: {
		stRet.sName = "Scintillating_Sphere";
		stRet.iSchool = 5;
		stRet.sTargetType = "0x3E";
		stRet.iCategory = 11;
		stRet.iLevel = 3;
	...
	case 533: {
		stRet.sName = "Black_Blade_of_Disaster";
		stRet.iSchool = 2;
		stRet.sTargetType = "0x2C";
		stRet.iCategory = 15;
		stRet.iLevel = 9;
	...
	case 534: {
		stRet.sName = "Shelgarns_Persistent_Blade";
		stRet.iSchool = 5;
		stRet.sTargetType = "0x2C";
		stRet.iCategory = 15;
		stRet.iLevel = 1;
	...
	case 569: {
		stRet.sName = "Cloud_of_Bewilderment";
		stRet.iSchool = 5;
		stRet.sTargetType = "0x2E";
		stRet.iCategory = 11;
		stRet.iLevel = 2;
...
string pGetSpellLeveledLessThen(int iLevel = 0, int iLessThan = 0,
	...
	for (i = 0; i <= 549; i++) {
		...
		if (pResponse(100 - iTrustPercent))
			continue;

		stSpell = pGetSpellInfo(i);

		if (stSpell.iLevel <= iLevel && stSpell.iLevel >= iLevel - iLessThan)
			sRet += (IntToString(i) + ",");
	};
...
string pGetSpellLeveledMoreThen(int iLevel = 0, int iMoreThan = 0,
	...
	for (i = 0; i <= 549; i++) {
		...
		if (stSpell.iLevel >= iLevel && stSpell.iLevel <= iLevel + iMoreThan)
			sRet += (IntToString(i) + ",");
	};
	sRet = GetStringLeft(sRet, GetStringLength(sRet) - 1);
...
string pGetSpellCategored(int iCategory = 0, int iTrustPercent = 20) {
	...
	for (i = 0; i <= 549; i++) {
		...
		if (stSpell.iCategory == iCategory)
			sRet += (IntToString(i) + ",");
	};
	sRet = GetStringLeft(sRet, GetStringLength(sRet) - 1);
